...
#define REVERSE                           D7  // binary output pin
#define THROTTLE                          D4  // PWM output pin
#define LEFT                              D5  // 1150hz PWM output pin
#define RIGHT                             D6  // 1150hz PWM output pin
#define BATTERY                           A5   // anaglogue input pin
