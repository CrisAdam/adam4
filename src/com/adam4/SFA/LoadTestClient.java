...
public class LoadTestClient
{
	...
	public static void main(final String[] args)
	{
		...
		try
		{
			...
			//URLConnection conn = new URL("https://www.google.com:443").openConnection(proxy);
			
			//URLConnection s = new URL("ec2-54-186-196-159.us-west-2.compute.amazonaws.com:9995").openConnection(proxy);
