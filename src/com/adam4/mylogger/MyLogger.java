...
public class MyLogger
{
    ...
    // todo: set parameters to discard certain LogLevel (I.E. debug) per individual iLogWriter
	
	private Sorter sorter;
	private String server, application;
	
	public MyLogger(String server, String application)
	{
		this.server = server;
    ...
    protected void finalize() throws Throwable
    {
        try
        {
            LogMessage(Thread.currentThread().getName(), "Logger was not cleanly closed", LogLevel.ERROR);
            close();
        }
        finally
        {
	...
	/* static methods 
	 * 
	 * This class is guaranteed to be instantiated prior to any of these being called.
	 * 
	 */
