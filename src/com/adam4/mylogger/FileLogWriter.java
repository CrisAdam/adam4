...
public class FileLogWriter implements iLogWriter, Runnable
{
	...
	public FileLogWriter(String filePath)
	{
		...
		{
		//	MyLogger.LogMessage(Thread.currentThread(), "Log target file already exists, appending", LogLevel.DEBUG, e);
		}
		catch (IOException e)
		{
			done = true;
		//	MyLogger.LogMessage(Thread.currentThread(), "Log target file error", LogLevel.DEBUG, e);
		}
		try
		{
    	...
    	//	MyLogger.LogMessage(Thread.currentThread(), "unable to initialize file writer", LogLevel.ERROR, e);
        }
	...
	protected void finalize() throws Throwable
    {
        try
        {
        //	MyLogger.LogMessage(Thread.currentThread().getName(), "FileLogger was not cleanly closed", LogLevel.ERROR);
            close();
        }
        finally
        {
