...
public class Controller {
    ...
    public static void main(String []args){
        ...
        PlaneControl[] entries = {new Starfox(ARENA_SIZE, ROUNDS), new DumbPlanes(ARENA_SIZE, ROUNDS), new DumbPlanes(ARENA_SIZE, ROUNDS)}; // Instances of all entries!!!
        String[] names = {"starfox", "DumbPlanes2", "DumbPlanes3"}; // corresponding names of all entries!!!
