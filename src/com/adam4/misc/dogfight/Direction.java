...
class Direction
{
    ...
    {
        return (((direction.getNSDir() - NS) * (direction.getNSDir() - NS) + (direction.getWEDir() - WE) * (direction.getWEDir() - WE) + (direction.getDUDir() - DU) * (direction.getDUDir() - DU)) < 3 && ((direction.getNSDir() != 0 && direction
                .getNSDir() == NS) || (direction.getWEDir() != 0 && direction.getWEDir() == WE) || (direction.getDUDir() != 0 && direction.getDUDir() == DU)));
    }
}
