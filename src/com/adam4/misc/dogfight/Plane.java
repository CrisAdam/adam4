...
public class Plane
{
    ...
    public String getAsString()
    {
        ...
        return "x: " + Integer.toString(position.x) + " y: " + Integer.toString(position.y) + " z: " + Integer.toString(position.z) + " direction: " + direction.getAsString() + " cool down: " + Integer.toString(coolDown);
    }
}
